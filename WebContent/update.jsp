	...
	<div class="container-fluid">
		<div class="row content">
				...
				<div class="col-sm-9" style="background-color:white;">
					...
					<h1> <small> Update Achats: </small></h1>
					<hr>
					<br>
					<%	
						...
						<div class="alert alert-danger alert-dismissible fade in">
						    ...
						    <li> Date of reception is a required field.</li>
						    </ul>
						</div>
						...
						<s:form action="process-update.html" method="post">
						<s:textfield label="Code Achat" name="achat.codeAchat" readonly="true" cssClass="form-control"></s:textfield>
						...
						<sj:datepicker id="date1" value="%{achat.dateReception}" name="dateReception" displayFormat="yy-mm-dd"  label="Date Reception" />
