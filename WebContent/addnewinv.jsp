...
<title>Ajouter une nouvelle inventaire</title>
	...
	<div class="container-fluid">
		<div class="row content">
				...
				<div class="col-sm-9" style="background-color:white;">
					...
					<br>
					<%
						//Message validation de la formulaire
						...
						<div class="alert alert-danger alert-dismissible fade in">
						    ...
						    <li> Description of inventory is a required field.</li>
						    </ul>
						</div>
						...
						%>
					<s:form action="process-addnewInv.html" method="post">
					<!-- DropDown Menu pour choisir un article-->
						 ...
						 <s:submit value="Add new Inventory" cssClass="btn btn-info"></s:submit>
					 </s:form>
					</div>  			
		</div>
	</div>
