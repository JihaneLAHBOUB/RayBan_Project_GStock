...
<title>CRUD_ gStock_achats</title>
...
<div class="container-fluid">
	<div class="row content">
			...
			<div class="col-sm-3 sidenav sidebar">
				<div id="admin">
					...
					<div id="mySidenav">
					 ...
					 <s:a href="home.jsp"><i class="fa fa-fw fa-home"></i> About Us </s:a>
			...
			<div class="col-sm-9" style="background-color:white;">
				...
				<span>
				<s:a href="addnew.html" cssClass="btn btn-info op" ><i class="fas fa-plus"></i></s:a> 
				
				<s:a href="search.html" cssClass="btn btn-info op"><i class="fas fa-search"></i></s:a>
				</span>
				<h1> <small> List Achats: </small></h1>
				<hr>
				<br>
				<table class="table table-striped table-hover" id="mytbl">
					...
					<tbody>
					<s:iterator var="achat" value="listAchats">
					<tr>
					<td><s:property value="#achat.codeAchat"/></td>
					<td><s:property value="#achat.codeArt"/></td>
					<td><s:property value="#achat.qteAchete"/></td>
					<td><s:date name="#achat.dateReception" format="yyyy-MM-dd"/></td>
					
							<td>
							&thinsp;
								<!-- Button pour modifier un achat -->
								<s:url var="updateURL" value="update.html">
									<s:param name="codeAchat"><s:property value="#achat.codeAchat" /></s:param>
								</s:url>
								<s:a href="%{updateURL}" cssClass="btn btn-primary">Update</s:a>
								&thinsp;
								<!-- Button pour supprimer un achat -->
								<s:url var="deleteURL" value="delete.html">
									<s:param name="codeAchat"><s:property value="#achat.codeAchat" /></s:param>
								</s:url>
